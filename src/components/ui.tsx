...
export const icons = {
  ...
  /* An empty photo frame — used where the wiki has no screenshot to show. */
  image: "M4 5h16a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1Zm0 11 5-5 4 4 3-3 5 5",
